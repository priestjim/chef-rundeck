...
template '/var/lib/rundeck/.chef/knife.rb' do
	...
	variables({
		...
		:chef_server_url => node['rundeck']['chef']['server_url'] || Chef::Config['chef_server_url']
	})
...
chef_rundeck_args = [
	'-a', node['rundeck']['chef']['server_url'] || Chef::Config['chef_server_url'],
	'-k', "/var/lib/rundeck/.chef/#{adminobj['client_name']}.pem",
	'-c', '/var/lib/rundeck/.chef/knife.rb',
	'-u ', node['rundeck']['ssh']['user'],
	'-w', node['rundeck']['chef']['server_url'] || Chef::Config['chef_server_url'],
